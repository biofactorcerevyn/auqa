...
export function Downloads({ onBack }: DownloadsProps) {
  ...
  const renderMaterialCard = (material: any) => (
    <Card
      key={material.id}
      className={`hover:shadow-lg transition-all duration-300 overflow-hidden ${selectedCategory === "all" ? "shrink-0 w-[280px]" : ""
        }`}
      style={{
    ...
    >
      <CardContent className="p-3">
        <div className="relative mb-3 rounded-lg overflow-hidden group" style={{ background: 'linear-gradient(135deg, var(--color-primary-100) 0%, var(--color-info-light) 100%)' }}>
          <button
          ...
          >
            <img
              ...
              className="w-full h-32 object-cover group-hover:scale-110 transition-transform duration-300"
            />
            <div className="absolute inset-0 flex items-end justify-center pb-2" style={{ background: 'linear-gradient(to top, var(--color-primary-80), transparent)' }}>
        ...
        <div className="mb-3">
          <h4 className="mb-2" style={{ fontSize: "13px", fontWeight: 600, color: 'var(--color-primary)' }}>
            {material.name}
          </h4>
        ...
        <Button
          onClick={() => handleDownload(material.name, selectedLanguage)}
          className="w-full flex items-center justify-center gap-2 text-white transition-shadow"
          style={{
  ...
  return (
    <div className="min-h-screen pt-28 pb-16" style={{ background: 'var(--bg-gradient)' }}>
      <div className="container mx-auto px-4 lg:px-8">
        {/* Back Button */}
        {onBack && (
          <button
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-3 mb-3">
            <Download className="h-10 w-10" style={{ color: 'var(--color-primary)' }} />
        ...
        <div className="max-w-6xl mx-auto mb-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            {/* Filter by Category */}
            <div className="rounded-lg p-4 shadow-sm" style={{ backgroundColor: 'var(--color-white)', border: '2px solid var(--color-primary-200)' }}>
              <div className="flex items-center gap-2 mb-3">
                <div className="relative shrink-0 size-[20px]">
                  <svg
                ...
                <p style={{ fontSize: "14px", fontWeight: 700, color: 'var(--color-primary)' }}>
                  Filter by Category
                </p>
              </div>
              <div className="flex flex-wrap gap-2">
                {categories.map((category) => (
                  <button
                    ...
                    style={{
                      ...
                      border: selectedCategory === category.id ? '2px solid var(--color-primary)' : '2px solid var(--color-primary-300)',
            ...
            <div className="rounded-lg p-4 shadow-sm" style={{ backgroundColor: 'var(--color-white)', border: '2px solid var(--color-primary-200)' }}>
              <div className="flex items-center gap-2 mb-3">
                ...
                <p style={{ fontSize: "14px", fontWeight: 700, color: '#4A5A3C' }}>
                  Filter by Language
                </p>
              </div>
              <div className="flex flex-wrap gap-2">
                {languages.map((lang) => (
                  <button
                    ...
                    style={{
                      fontSize: "13px",
                      fontWeight: 500,
                      backgroundColor: selectedLanguage === lang.code ? '#4A5A3C' : '#FFFFFF',
                      color: selectedLanguage === lang.code ? 'white' : '#2D2D2D',
                      border: selectedLanguage === lang.code ? '2px solid #4A5A3C' : '2px solid rgba(74, 90, 60, 0.3)',
                      boxShadow: selectedLanguage === lang.code ? '0 4px 6px -1px rgba(0, 0, 0, 0.1)' : 'none',
